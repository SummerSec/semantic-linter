...
// 英文词汇对 (E01-E10)
const enPairs = [
  { id: 'E01', narrow: 'Vulnerability', wide: 'Risk', severity: 'critical', scenario: '同 T01' },
  { id: 'E02', narrow: 'Check', wide: 'Review', wideAlt: 'Audit', severity: 'high', scenario: '"Review"和"Audit"触发全面评价' },
  { id: 'E03', narrow: 'List', wide: 'Describe', wideAlt: 'Explain', severity: 'high', scenario: '"Describe"触发叙述性展开' },
  { id: 'E04', narrow: 'Bug', narrowAlt: 'Defect', wide: 'Issue', wideAlt: 'Problem', severity: 'high', scenario: '"Issue"覆盖面过宽' },
  { id: 'E05', narrow: 'Summarize', wide: 'Analyze', wideAlt: 'Assess', severity: 'medium-high', scenario: '"Analyze"触发深度推理' },
  { id: 'E06', narrow: 'Requirement', wide: 'Suggestion', wideAlt: 'Recommendation', severity: 'medium-high', scenario: '"Recommendation"触发发散' },
  { id: 'E07', narrow: 'Error', wide: 'Anomaly', wideAlt: 'Concern', severity: 'medium', scenario: '"Concern"几乎无边界' },
  { id: 'E08', narrow: 'Extract', wide: 'Interpret', severity: 'high', scenario: '"Interpret"触发主观解读' },
  { id: 'E09', narrow: 'Verify', wide: 'Evaluate', wideAlt: 'Judge', severity: 'medium-high', scenario: '"Evaluate"触发多维评价' },
  { id: 'E10', narrow: 'Must', narrowAlt: 'Shall', wide: 'Should', wideAlt: 'Could', severity: 'medium-high', scenario: '"Should"暗示可选，"Must"要求强制' },
];
