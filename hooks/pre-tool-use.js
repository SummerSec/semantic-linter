...
const { readStdin, outputJson, computeEscalation } = require(path.join(__dirname, '..', 'lib', 'hook-utils'));
...
let report = reportFormatter.formatPre(lexiconMatches, structuralRisks, absFile);
