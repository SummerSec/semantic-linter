...
![准确率对比仪表盘：89.3% vs 62.1%](./pic/02-accuracy-dashboard.png)
...
![两份报告对比：精准聚焦 vs 发散失控](./pic/03-report-comparison.png)
...
![6步结构化工作流管道](./pic/04-six-step-workflow.png)
...
![校验-执行-验证循环机制](./pic/05-validation-cycle.png)
...
![定义文件结构示意](./pic/06-definition-structure.png)
...
![领域定制工具链架构](./pic/07-custom-toolchain.png)
...
![构建高质量Skill的四大核心支柱](./pic/08-four-pillars.png)
...
!["漏洞"的紧凑聚焦语义空间](./pic/09-semantic-vulnerability.png)
...
!["风险"的发散扩张语义空间](./pic/10-semantic-risk.png)
...
![错误模式分布：范围溢出68%、等级虚高24%、逻辑偏移8%](./pic/11-error-patterns.png)
...
![仓库盘点类比：精准检查 vs 过度发散](./pic/12-warehouse-analogy.png)
...
![LLM语义敏感度矩阵：安全区与危险区](./pic/13-semantic-matrix.png)
...
![围墙与砖块：语义膨胀撑裂约束边界](./pic/14-expanding-bricks.png)
...
![三种边界锚定策略：否定清单、硬约束、反例强化](./pic/16-anchoring-strategies.png)
...
![语义陷阱检测器四步工作流](./pic/17-detector-workflow.png)
...
![三种系统化语义漂移测试方法](./pic/15-testing-methods.png)
...
```
![Skill开发CI/CD流程：将语义检测嵌入管道](./pic/18-cicd-pipeline.png)
